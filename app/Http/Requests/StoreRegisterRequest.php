...
class StoreRegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "mobile" => [new SaudiMobileNumber(), "required", "unique:registers,mobile"],
            "id_number"  => ["required", "min:10", "max:10", "unique:registers,id_number"],
            'statement' => ['required', "file", "mimes:pdf,doc,docx,jpg,jpeg,png", "max:4056"],
