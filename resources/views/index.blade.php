...
@section('content')
    ...
    <div class="site-intro">
        <div>
            <h1 class="site-title">جمالك يستحق الأفضل </h1>
            <p class="site-description"> نجعل من أحلامك واقعاً، باستخدام أحدث التقنيات وأفضل الخبراء. دعنا نساعدك على
    ...
    <x-wave-container>
        <div class="container mr-auto  machine-info-container  ml-auto" >
            ...
            <div class="site-section flex-2 machine-info  reverse">
                ...
                <div>
                    <img src="{{ asset('assets/images/section-2.png') }}" alt="" class="block-img">
                </div>
            </div>
        </div>
    </x-wave-container>
    ...
    <div class="container">
        <x-figure-title>خدمات متنوعة</x-figure-title>
        ...
        <section class="site-section  contact-section">
            ...
            <x-splade-form>
                ...
                <x-splade-input label="الاسم " name="name" class="input-container" />
                <x-splade-input label="رقم الجوال" name="mobile" class="input-container" />


                <div class="input-container mt-8 mb-4"><label>المنطقة المطلوبة</label></div>

                <div class="flex-grow-con">
                    <x-custom-radio name="area" value="1" label="الرياض">
                        <div class="title-icon">
                            <img src="{{ asset('assets/images/body.png') }}" />
                            <p>منطقة</p>
                        </div>
                    </x-custom-radio>
                    <x-custom-radio name="area" value="2" label="الرياض">
                        <div class="title-icon">
                            <img src="{{ asset('assets/images/body.png') }}" />
                            <p>الجسم كامل</p>
                        </div>
                    ...
                    <x-custom-radio name="area" value="3" label="الرياض">
                        <div class="title-icon">
                            <img src="{{ asset('assets/images/body.png') }}" />
